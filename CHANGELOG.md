...
### 新增
- 新增 `/news_clear_cache`，用于清除已推送新闻去重缓存
...
### 变更
- GitHub Trending 输出数量从 5 条调整为 10 条
- 编号后处理现在会识别 `科技热点`、`AI动态`、`GitHub Trending` 等非 Markdown 分区标题，并强制每个分区从 `1.` 重新编号
